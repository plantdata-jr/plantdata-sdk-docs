...
export declare abstract class PdSDKEditorDefine extends PdSDKEditorTool {
     ...
     */
    protected constructor(settings?: PdSDKEditorDefineSettings);
    /**
     * 新增属性
     * @param data - 属性数据
     */
    abstract addAttribute(data: any): Promise<number | string>;
    /**
     * 删除属性
     * @param id - 属性Id
     */
     ...
     * @param data - 属性数据
     */
    abstract updateAttribute(data: any): Promise<string | number>;
    /**
     * 根据选中节点更新状态
