...
import { PdVisNetChart, PdVisNetChartDataLink, PdVisNetChartDataNode, PdVisNodeId } from '../../../../vis/netchart/netchart';
 ...
 * 实体事件数据
 */
export interface PdSDKPluginEventDataNode extends PdVisNetChartDataNode {
    /**
     *  事件发生时间列表
     */
    fromTime?: string;
 ...
 * 关系事件完整数据
 */
export interface PdSDKPluginEventLinkEvent extends PdSDKPluginEventDataLink, PdSDKPluginEventDataEvent {
    /**
     *  事件关联的原对象ID列表
     */
    fromIds?: PdVisNodeId[];
 ...
 * 实体事件完整数据
 */
export interface PdSDKPluginEventNodeEvent extends PdSDKPluginEventDataNode, PdSDKPluginEventDataEvent {
    /**
     * 事件id
     */
    id: PdVisNodeId;
...
export declare class PdSDKPluginEvent extends PdSDKPlugin {
     ...
     * 渲染可视事件列表
     */
    protected rendererEvents(pageNo?: number): void;
    /**
     * 生成完整事件数据
     */
