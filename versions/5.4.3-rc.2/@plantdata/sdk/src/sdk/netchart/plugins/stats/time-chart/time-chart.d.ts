...
export interface PdSDKPluginTimeChartSettings extends PdSDKPluginSettings {
     ...
     * @param end 选择的结束时间
     */
    dataFilter?: (data: PdVisNetChartData, settings: PdSDKPluginTimeFilterSettings, start?: string, end?: string) => PdVisNetChartData;
}
/**
 * 时序数据过滤设置
 */
...
export declare class PdSDKPluginTimeChart extends PdSDKPlugin {
     ...
     */
    protected dataFilter(data: PdVisNetChartData, settings: PdSDKPluginTimeFilterSettings, start?: string, end?: string): PdVisNetChartData;
    /**
     * 禁用时序插件
     */
