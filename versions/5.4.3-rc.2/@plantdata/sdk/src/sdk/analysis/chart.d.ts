...
import { PdSDKAjaxSettings, PdSDKBaseSettings } from '../utils/utils';
import { PdVisChart, PdVisChartSettings } from '../../vis/chart';
...
export declare abstract class PdSDKChartAnalysis<T extends PdVisChart, V extends PdVisChartSettings> extends PdComponent {
     ...
     */
    constructor(settings: PdSDKChartAnalysisSettings<V>);
    /**
     * 销毁实例
     */
    destroy(): void;
     ...
     */
    protected loader(): ($self: any, lp: any) => Promise<any>;
    /**
     * 组件JQuery容器生成后回调
     */
