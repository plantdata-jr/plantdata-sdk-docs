...
export declare class PdSDKPluginRelation extends PdSDKPlugin {
     ...
     */
    protected addRelationNode(node: PdSDKNetChartDataNode): void;
    /**
     * 绑定事件
     */
     ...
     */
    protected getRelationNodes(): PdSDKNetChartDataNode[];
    /**
     * 是否已选择为关联分析的节点
     * @param {PdSDKNetChartDataNode} node - 待分析的节点
     * @return {boolean} 是否已选择为关联分析的节点
     */
    protected inRelationNodes(node: PdSDKNetChartDataNode): boolean;
    /**
     * 初始化配置
