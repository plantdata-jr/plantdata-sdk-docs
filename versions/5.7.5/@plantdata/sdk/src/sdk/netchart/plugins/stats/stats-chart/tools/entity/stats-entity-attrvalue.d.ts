 ...
 * 图统计配置项
 */
export interface PdSDKPluginStatsEntityAttrValueConfig extends PdSDKPluginStatsNetChartBarToolConfig {
    /**
     *  所属关系
     */
    attrId?: number;
 ...
 * SDK 实体按属性值统计配置
 */
export interface PdSDKPluginStatsEntityAttrValueSettings extends PdSDKPluginStatsNetChartToolSettings<PdSDKPluginStatsEntityAttrValueConfig> {
    /**
     * 高亮的模式
     */
 ...
 * SDK 实体按属性值统计
 */
export declare class PdSDKPluginStatsEntityAttrValue extends PdSDKPluginStatsNetChartTool<PdSDKPluginStatsEntityAttrValueConfig> {
    /**
     *  默认配置
     */
