...
export declare abstract class PdVisPluginEdit extends PdVisPlugin {
    ...
    /**
     * 获取当前编辑的结果
     * @param checkedOnly - 标识是否指获取已选中的项的值
     */
    getData(checkedOnly?: boolean): any;
    /**
     * 设置编辑选项的值
     * @param data 选项的值
    ...
    /**
     * 获取编辑项的结果
     * @param $parent 编辑项的DOM容器
     * @param settings 编辑项的配置
     * @param checkedOnly - 标识是否指获取已选中的项的值
     * @param parent 编辑项的父路径
     */
    protected getDataItem($parent: JQuery, settings: PdVisPluginEditItemSettings[], checkedOnly: boolean, parent?: string): any;
    /**
     * 获取指定路径的编辑项的配置
     ...
     * @param parent 编辑项的父路径
     */
    protected setDataItem(data: any, $parent: JQuery, settings: PdVisPluginEditItemSettings[], parent?: string): void;
    /**
     * 显示添加弹框
     * @param event 点击事件
     */
